 ...
 *     without debug info and strip the jar of unnecessary files)</li>
 * <li>Unit and integration tests - fast setup/teardown times, small overhead
 *     and simple context handler setup make it a great webserver for testing
...
public class HTTPServer {
     ...
     *
     * @see VirtualHost#addContext(String, ContextHandler, String...)
     */
     ...
     * If null, a default Executor is used.
     *
     ...
     * until the steams are closed, an error occurs, or the request
    ...
    protected void handleConnection(InputStream in, OutputStream out) throws IOException {
        ...
        do {
            ...
            try {
                ...
                resp.sendError(500, "error processing request: " + ioe.getMessage());
                break;
            }
    ...
    public static String getContentType(String path, String def) {
        ...
        String type = dot < 0 ? def : contentTypes.get(path.substring(dot + 1).toLowerCase());
